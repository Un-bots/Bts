...
ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ ʀᴇᴍᴏᴠᴇ ᴍᴏᴅᴜʟᴇ:

◌ /remove : ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴠɪᴅᴇᴏ ᴛᴏ ʀᴇᴍᴏᴠᴇ ᴀᴜᴅɪᴏ ᴏʀ ᴠɪᴅᴇᴏ.

E.ɢ. /remove ᴀᴜᴅɪᴏ ᴏʀ /remove ᴠɪᴅᴇᴏ.
'''
    HELP_GETSTATE = '''sᴛᴀᴛᴇs

ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ sᴛᴀᴛᴇs ᴍᴏᴅᴜʟᴇ:

◌ /get_states : Pʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴄᴏᴜɴᴛʀʏ ɴᴀᴍᴇ ᴀғᴛᴇʀ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ, ʟɪᴋᴇ ᴛʜɪs:
/get_states Cᴀɴᴀᴅᴀ
'''
    HELP_NIGHTMODE = '''ɴɪɢʜᴛᴍᴏᴅᴇ

ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ ɴɪɢʜᴛᴍᴏᴅᴇ ᴍᴏᴅᴜʟᴇ:

◌ /nightmode : ᴜsᴇ ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ᴀғᴛᴇʀ ᴄᴏᴍᴍᴀɴᴅ.
'''
    HELP_GITHUB = '''ɢɪᴛʜᴜʙ

ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ ɢɪᴛʜᴜʙ ᴍᴏᴅᴜʟᴇ:

ɢɪᴛʜᴜʙ
◌ /git : ᴇɴᴛᴇʀ ᴀ GɪᴛHᴜʙ ᴜsᴇʀɴᴀᴍᴇ ᴀғᴛᴇʀ ᴛʜᴇ /git ᴏʀ /github ᴄᴏᴍᴍᴀɴᴅ.

◌ /downloadrepo :  ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇ GɪᴛHᴜʙ ʀᴇᴘᴏsɪᴛᴏʀʏ URL ᴀғᴛᴇʀ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ.

◌ /unzip : Rᴇᴘʟʏ ᴛᴏ ᴀ ᴢɪᴘ ғɪʟᴇ ᴡɪᴛʜ /unzip ᴛᴏ ᴇxᴛʀᴀᴄᴛ ɪᴛs ᴄᴏɴᴛᴇɴᴛs.

◌ /allrepo : ᴇɴᴛᴇʀ ᴀ GɪᴛHᴜʙ ᴜsᴇʀɴᴀᴍᴇ ᴀғᴛᴇʀ ᴛʜᴇ /allrepo ᴄᴏᴍᴍᴀɴᴅ.
'''
    HELP_MOVIE = '''ᴍᴏᴠɪᴇ

ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ ᴍᴏᴠɪᴇ ᴍᴏᴅᴜʟᴇ:

◌ /movie : ɢɪᴠᴇ ᴀ ᴍᴏᴠɪᴇ ᴀɴᴅ ᴛᴏ sᴇᴀʀᴄʜ ᴅᴇᴛᴀɪʟs.
'''
    HELP_MEME = '''ᴍᴇᴍᴇs

ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ғᴏʀ ᴛʜᴇ ᴍᴇᴍᴇs ᴍᴏᴅᴜʟᴇ:

◌ /meme : ɢᴇɴᴇʀᴀᴛᴇ ʀᴇɴᴅᴏᴍ ᴍᴇᴍᴇs.
'''
